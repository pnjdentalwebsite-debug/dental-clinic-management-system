...
export function StaffActionMenu({ status = 'active', onAction }: Props) {
          ...
          >
            ...
            {normalized !== 'active' && (
              <button
                type="button"
                onClick={() => {
                  onAction('Activate Staff Member');
                  setOpen(false);
                }}
                style={{
                  padding: '8px 12px',
            ...
            {normalized === 'active' && (
              <button
                type="button"
                onClick={() => {
                  onAction('Deactivate Staff Member');
                  setOpen(false);
                }}
                style={{
                  padding: '8px 12px',

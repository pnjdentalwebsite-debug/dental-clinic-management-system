...
export function ClinicDetailsPage({ clinicId, navigate, showToast, refreshShell }: Props) {
  ...
  return (
    <main className="main-content">
      ...
      <div className="summary-grid"><Summary label="Dentists" value={dentists.length} /><Summary label="Staff" value={staff.length} /><Summary label="Assignments" value={activeAssignments.length} /><Summary label="Plan Usage" value={plan ? `${plan.name} Plan` : 'Unavailable'} /></div>

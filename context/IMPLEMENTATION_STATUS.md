...
70. **Phase 2E.3C.2A Secure Associate Dentist Provisioning / Edit Backend Contract (August 31, 2026)**:
    ...
    - `complete-initial-password` now supports an active password-gated Associate membership as well as Clinic Owner, preserving the first-login RLS gate. The Phase 2E.3C.1 frontend Add/Edit, credential, assignment, and lifecycle controls remain unavailable and are not wired to this contract.
    ...
    - **PHASE 2E.3C.1 = COMPLETE / VERIFIED CHECKPOINT. PHASE 2E.3C.2A = SECURE ASSOCIATE DENTIST PROVISIONING / EDIT BACKEND CONTRACT / REMOTELY DEPLOYED AND VERIFIED / READY FOR VERIFIED BACKEND CHECKPOINT.** Frontend Add/Edit remains disabled and unwired.
